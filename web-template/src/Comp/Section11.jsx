        ...
        <div className="row m-0 p-0 mt-5">
            <div className="col col-lg-3 col-md-3 col-sm-6 col-12">
                ...
                <div className="row m-0 p-0 mt-5">
                    <div className="col col-lg-3 col-md-3 col-sm-3 col-3">
                        <img className='img-fluid' src="icon1.jpg" alt="" />
                    </div>
                    <div className="col col-lg-3 col-md-3 col-sm-3 col-3">
                        <img className='img-fluid' src="icon2.jpg" alt="" />
                    </div>
                    <div className="col col-lg-3 col-md-3 col-sm-3 col-3">
                        <img className='img-fluid' src="icon3.jpg" alt="" />
                    </div>
                    <div className="col col-lg-3 col-md-3 col-sm-3 col-3">
                        <img className='img-fluid' src="icon4.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div className="col col-lg-3 col-md-3 col-sm-6 col-12">
            ...
            <div className="col col-lg-3 col-md-3 col-sm-6 col-12">
                <div className="j-2">
                    ...
                    <h6><a href="">Orders Tracking</a></h6>
                    <h6><a href="">Checkout</a></h6>
            ...
            <div className="col col-lg-3 col-md-3 col-sm-6 col-12">
                <div className="g-3">
                    ...
                    <div className="row m-0 p-0">
                       <div className=" g-4 col col-lg-6 col-md-6 col-sm-6 col-6">
